    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php include_once 'headerTemplate.php';?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Ingreso de orden directa a recepcion</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Ingresar Orden</h6>
            </br>
 ...
 $(document).ready(function(){  
  ...
  setInterval(function(){ cargarHora(); }, 1000);
      ...
      $(document).on('click', '.save_data', function(){  
          ...
          var hora_recibido = document.getElementById('horaMensajero').value;
          var fecha_recibido = document.getElementById('fechaMensajero').value;
          var sucursal= document.getElementById('id_sucursal').value;

        console.log(`Datos:{ ${sticker},${hora_recibido},${fecha_recibido},${sucursal} }`);
           if(sticker != '')  
           {  
                $.ajax({  
                     url:"../controlador/registroController.php?accion=pasoIndependiente",  
                     method:"POST",  
                     data:{sticker:sticker,hora_recibido:hora_recibido,fecha_recibido:fecha_recibido,id_sucursal:sucursal},  
                     success:function(data){ 
